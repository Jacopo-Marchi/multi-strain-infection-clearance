...
#GENERATES FIG S2 OF THE MANUSCRIPT
...
then
    ...
    for p in  0.5 # -1 means no resistance. Other negative values determine phages with different phis and p is then set to 1
    do
