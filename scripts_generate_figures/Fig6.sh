...
#GENERATES FIG 6 OF THE MANUSCRIPT, as well as Figure S1 S3 and S4
...
then
    ...
    for p in  0. 0.5 1. -1 -5 -0.2 # -1 means no resistance. Other negative values determine phages with different phis and p is then set to 1
    #~ for p in  -0.2 -5 # -1 means no resistance. Other negative values determine phages with different phis and p is then set to 1
    do
