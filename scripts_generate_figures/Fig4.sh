...
# GENERATES FIG 2 AND 3 OF THE MANUSCRIPT
...
then
    ...
    model='cocktail_r1r2' # cocktail, worstphage, singlephage
    #~ model='singlephage' # cocktail, cocktail_r1r2, singlephage
    
    IC_mode='rightphage' # rightphage_low

    data_dir_tot='../../'models_exploration_Iphi_extthr_FIN/${model}/
...
# cycle over some parameters
  

    for p in   1.   # Only relevant for fig 6
    do
    ...
    for phi in   '2e-12'  '4e-12'  '7e-12'  '1e-11' '2e-11'  '4e-11'  '7e-11'   '1e-10' '2e-10'  '3e-10'  '4e-10'  '7e-10'   '1e-9'  '1e-8'  '4e-8'  '7e-8' '1e-7'  '4e-7'  '7e-7' '1e-6' 
    do
    ...
    do
        ...
        do
            ...
            do
                ...
                for I in     '1e04'  '1e05'   '1e06'   '2e06'  '5e06'   '10e06'  '15e06' '20e06' '30e06'  '40e06'   '60e06'    '80e06'    '100e06'  '2e08'  '4e08'  '6e08'  '8e08'  '1e09'   '2e09'   '4e09'
                do
                    ...
                    python infection_dynamics.py "$data_dir_fin"
