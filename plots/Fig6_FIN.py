...
def plot_summary_diagram(phi, I, array_z , zlabel):
    ...
    ax.plot(phi_finer,I_suigreatb0_finer,color='k',linestyle='--', linewidth=3)
    
    ax.plot(phi_finer,I_LB,color='b',linestyle='--', linewidth=3)
    ax.plot(phi_finer,I_p1,color='g',linestyle='--', linewidth=3)
    ...
    out_file='{out}/Fig6.pdf'.format(out=dir_out_plots_tot)
    
    fig.savefig(out_file)#,bbox_inches='tight'

dir_io='../../models_exploration_Iphi_realpars_FIN/cocktail_r1r2/short_grid_scan_fctphagepars_rightphage_low/summary_analysis_p_1d/' # directory with input files
...
I_ruigreatb0_finer= (r - phi_finer*P_c/2)/kappa 
I_ruipgreatb0_finer= (r - phi_finer*P_c/4)/kappa 
